...
//       background-color: ${props.isActive ? theme.colors.secondary : theme.colors.white};
//       color: ${props.isActive ? theme.colors.white : theme.colors.gray};
//       ${theme.font(18, 600)};
//       margin: 5px 5px;
//     `;
//   }}
...
//             onClick={() => api.handleUpdateRoutineValue(routineId, 'currentSession', i)}
